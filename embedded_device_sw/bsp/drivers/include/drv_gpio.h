 ...
 */
typedef struct {
	int (*configure)(const object *obj, gpio_pin_id_t pin,
			 const gpio_config_t *config);
	int (*write)(const object *obj, gpio_pin_id_t pin,
		     gpio_pin_level_t level);
	int (*toggle)(const object *obj, gpio_pin_id_t pin);
	int (*read)(const object *obj, gpio_pin_id_t pin,
		    gpio_pin_level_t *level);
} gpio_intf_t;
 ...
 */
static inline int gpio_configure(const object *		obj,
				 gpio_pin_id_t		pin,
				 const gpio_config_t *	config)
{
	gpio_intf_t *intf;
 ...
 * @retval  Returns 0 on success, negative error code otherwise.
 */
static inline int gpio_write(const object *	obj,
			     gpio_pin_id_t	pin,
			     gpio_pin_level_t	level)
{
	gpio_intf_t *intf;
 ...
 * @retval  Returns 0 on success, negative error code otherwise.
 */
static inline int gpio_read(const object *	obj,
			    gpio_pin_id_t	pin,
			    gpio_pin_level_t *	level)
{
	gpio_intf_t *intf;
