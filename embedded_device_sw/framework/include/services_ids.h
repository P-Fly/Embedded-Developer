...
#define MSG_ID_LED_SERVICE_FLASH_ONCE_EVT (MSG_TYPE_EVT_BASE | \
					MSG_ID_LED_SERVICE_BASE | 0x0001)
#define MSG_ID_LED_SERVICE_FLASH_TWICE_EVT (MSG_TYPE_EVT_BASE | \
					MSG_ID_LED_SERVICE_BASE | 0x0002)
#define MSG_ID_LED_SERVICE_REPEAT_QUICK_FLASH_EVT (MSG_TYPE_EVT_BASE | \
					MSG_ID_LED_SERVICE_BASE | 0x0003)
#define MSG_ID_LED_SERVICE_REPEAT_SLOW_FLASH_EVT (MSG_TYPE_EVT_BASE | \
					MSG_ID_LED_SERVICE_BASE | 0x0004)
