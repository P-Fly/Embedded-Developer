...
#define MSG_ID_LED_SERVICE_QUICK_FLASH_EVT (MSG_TYPE_EVT_BASE | MSG_ID_LED_SERVICE_BASE | 0x0001)
#define MSG_ID_LED_SERVICE_SLOW_FLASH_EVT (MSG_TYPE_EVT_BASE | MSG_ID_LED_SERVICE_BASE | 0x0002)
