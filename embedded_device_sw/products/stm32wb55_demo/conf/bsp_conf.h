...
#define CONFIG_UART1_HW_CONFIGS UART_CONFIG_WORD_LENGTH_8B | UART_CONFIG_STOP_BITS_1 \
                                | UART_CONFIG_PARITY_NONE | UART_CONFIG_MODE_TX_RX
#endif

#define CONFIG_CRC_ENABLE
#if defined(CONFIG_CRC_ENABLE)
#define CONFIG_CRC_NAME STM32WBXX_CRC
...
#define CONFIG_CRC_HW_CONFIGS CRC_CONFIG_POLYNOMIAL_LENGTH_32B | CRC_CONFIG_INPUT_32B
#endif
