...
#define MSG_ID_SERVICE_INIT_EVT         (MSG_TYPE_EVT_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x01)
#define MSG_ID_SERVICE_START_EVT_TEST   (MSG_TYPE_EVT_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x02)
#define MSG_ID_SERVICE_START_REQ_TEST   (MSG_TYPE_EVT_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x03)
#define MSG_ID_SERVICE_SEND_REQ         (MSG_TYPE_EVT_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x04)
#define MSG_ID_SERVICE_DATA_EVT         (MSG_TYPE_EVT_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x05)
#define MSG_ID_SERVICE_DATA_REQ         (MSG_TYPE_REQ_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x05)
#define MSG_ID_SERVICE_DATA_RSP         (MSG_TYPE_RSP_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x05)
#define MSG_ID_SERVICE_DATA_BROADCAST   (MSG_TYPE_EVT_BASE | MSG_ID_TUNIT_SERVICE_BASE | 0x06)
