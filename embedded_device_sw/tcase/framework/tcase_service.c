...
#define MSG_ID_SERVICE_INIT_EVT (CONFIG_MSG_ID_SERVICE_EVT_BASE | 0x01)
#define MSG_ID_SERVICE_START_EVT_TEST (CONFIG_MSG_ID_SERVICE_EVT_BASE | 0x02)
#define MSG_ID_SERVICE_START_REQ_TEST (CONFIG_MSG_ID_SERVICE_EVT_BASE | 0x03)
#define MSG_ID_SERVICE_SEND_REQ (CONFIG_MSG_ID_SERVICE_EVT_BASE | 0x04)
#define MSG_ID_SERVICE_DATA_EVT (CONFIG_MSG_ID_SERVICE_EVT_BASE | 0x05)
#define MSG_ID_SERVICE_DATA_REQ (CONFIG_MSG_ID_SERVICE_REQ_BASE | 0x05)
#define MSG_ID_SERVICE_DATA_RSP (CONFIG_MSG_ID_SERVICE_RSP_BASE | 0x05)
#define MSG_ID_SERVICE_DATA_BROADCAST (CONFIG_MSG_ID_SERVICE_EVT_BASE | 0x06)
